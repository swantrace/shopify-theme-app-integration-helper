...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"../node_modules/sizzle/dist/sizzle.js":[function(require,module,exports) {
var define;
/*!
...
},{"./utils":"../node_modules/axios/lib/utils.js","./helpers/normalizeHeaderName":"../node_modules/axios/lib/helpers/normalizeHeaderName.js","./adapters/xhr":"../node_modules/axios/lib/adapters/xhr.js","./adapters/http":"../node_modules/axios/lib/adapters/xhr.js","process":"../../../../.nvm/versions/node/v10.14.1/lib/node_modules/parcel-bundler/node_modules/process/browser.js"}],"../node_modules/axios/lib/core/InterceptorManager.js":[function(require,module,exports) {
'use strict';
...
var XElement = function XElement(htmlElement) {
...
XElement.prototype.catch = function () {
  var selector = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : throwIfMissing('selector');

  var _ref = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
      _ref$callback = _ref.callback,
      callback = _ref$callback === void 0 ? function (htmlElement) {
    console.log(htmlElement);
  } : _ref$callback,
      _ref$times = _ref.times,
      times = _ref$times === void 0 ? Number.MAX_SAFE_INTEGER : _ref$times,
      _ref$first_time = _ref.first_time,
      first_time = _ref$first_time === void 0 ? true : _ref$first_time;
  ...
  var initialElements = (0, _sizzle.default)(selector, currentElement);
    ...
    mutationsList.forEach(function (mutationRecord) {
      if (mutationRecord.type === 'childList') {
        mutationRecord.addedNodes.forEach(function (addedNode) {
          ...
          if (_sizzle.default.matchesSelector(addedNode, selector)) {
            relatedElements.push(addedNode);
          } else if ((0, _sizzle.default)(selector, addedNode) && (0, _sizzle.default)(selector, addedNode).length > 0) {
            relatedElements = relatedElements.concat((0, _sizzle.default)(selector, addedNode));
          }
        });
      }

      if (mutationRecord.type === 'attributes') {
        if (!initialElements.includes(mutationRecord.target) && _sizzle.default.matchesSelector(mutationRecord.target, selector)) {
          relatedElements.push(mutationRecord.target);
        }
      }

      if (mutationRecord.type === 'characterData') {
        if (mutationRecord.target.parentNode && !initialElements.includes(mutationRecord.target.parentNode) && _sizzle.default.matchesSelector(mutationRecord.target.parentNode, selector)) {
...
XElement.prototype.lose = function () {
  ...
  var _ref2 = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
      ...
      callback = _ref2$callback === void 0 ? function (htmlElement) {
    console.log(htmlElement);
  } : _ref2$callback,
      _ref2$times = _ref2.times,
      times = _ref2$times === void 0 ? Number.MAX_SAFE_INTEGER : _ref2$times;
    ...
    mutationsList.forEach(function (mutationRecord) {
      if (mutationRecord.type === 'childList') {
        mutationRecord.removedNodes.forEach(function (removedNode) {
          var clonedMutationTarget = mutationRecord.target.cloneNode(true);
          clonedMutationTarget.appendChild(removedNode);

          if (!_sizzle.default.matchesSelector(mutationRecord.target, selector) && _sizzle.default.matchesSelector(clonedMutationTarget, selector) || (0, _sizzle.default)(selector, clonedMutationTarget).length > (0, _sizzle.default)(selector, mutationRecord.target).length) {
            relatedElements.push(mutationRecord.target);
          }
        });
      }
      ...
      if (mutationRecord.type === 'characterData') {
        var currentTextContent = mutationRecord.target.textContent;
        mutationRecord.target.textContent = mutationRecord.oldValue;
        var clonedMutationTargetParent = mutationRecord.target.parentNode.cloneNode(true);
        mutationRecord.target.textContent = currentTextContent;

        if (!_sizzle.default.matchesSelector(mutationRecord.target.parentNode, selector) && _sizzle.default.matchesSelector(clonedMutationTargetParent, selector) || (0, _sizzle.default)(selector, clonedMutationTargetParent).length > (0, _sizzle.default)(selector, mutationRecord.target).length) {
          relatedElements.push(mutationRecord.target);
        }
      }
    });
...
function throwIfMissing(name) {
  throw new Error("Missing a ".concat(name, " as the parameter"));
}

var X = function X(htmlElement) {
  return function () {
...
X.find = _sizzle.default;
X.ajax = _axios.default;
window.X = X;
window.xbody = xbody;
},{"sizzle":"../node_modules/sizzle/dist/sizzle.js","axios":"../node_modules/axios/index.js"}],"../../../../.nvm/versions/node/v10.14.1/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../../../.nvm/versions/node/v10.14.1/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","../src/index.js"], null)
