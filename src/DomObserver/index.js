            ...
            if (mutationRecord.type === 'childList') {
                mutationRecord.removedNodes.forEach(function (removedNode) {
                    ...
                    if (mutationRecord.nextSibling === null) {
                        ...
                        var index = Array.from(mutationRecord.target.childNodes).indexOf(mutationRecord.nextSibling);
                        clonedMutationTarget.insertBefore(removedNode, clonedMutationTarget.childNodes[index])
                    }
...
module.exports = {onceElementsAppeared, onceElementsDisappeared}